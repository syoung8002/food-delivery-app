    ...
    <div>
        ...
        >
            <v-row>
                <v-list-item class="d-flex" style="background-color: white;">
                    ...
                    <div class="secondary-text-color" style="margin-left:30px;">주문에 대한 정보를 포함합니다.</div>
                </v-list-item>
            </v-row>
        </v-card>
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    <CustomerManagementOrder :offline="offline" class="video-card" :isNew="true" :editMode="true" v-model="newValue" 
        ...
        <v-row>
            <CustomerManagementOrder :offline="offline" class="video-card" v-for="(value, index) in values" v-model="values[index]" v-bind:key="index" @delete="remove"/>
        </v-row>
    </div>
</template>
...
<script>
    ...
    import CustomerManagementOrder from './../CustomerManagementOrder.vue';

    export default {
        name: 'CustomerManagementOrderManager',
        components: {
            CustomerManagementOrder,
        },
        props: {
            offline: Boolean
        },
